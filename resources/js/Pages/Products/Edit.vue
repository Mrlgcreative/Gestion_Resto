    ...
    <Card class="max-w-2xl">
      <form @submit.prevent="submit" class="space-y-6">
        ...
        <div class="border-t pt-6">
          <h3 class="font-semibold mb-4">Ingrédients</h3>
          ...
          <div v-for="(item, index) in form.ingredients" :key="index" class="flex items-end gap-4 mb-4">
            ...
            <Button variant="ghost" size="sm" @click="removeIngredient(index)">
        ...
        <div class="flex justify-end gap-4 border-t pt-6">
          <Button variant="secondary" @click="$inertia.visit('/products')">
            Annuler
          </Button>
...
const profit = computed(() => {
  return parseFloat(form.selling_price || 0) - parseFloat(form.base_price || 0);
});
...
const addIngredient = () => {
  form.ingredients.push({ id: '', quantity: '' });
};
