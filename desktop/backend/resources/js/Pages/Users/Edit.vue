    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6 max-w-2xl">
      <form @submit.prevent="submit" class="space-y-6">
        ...
        <div class="border-t pt-4">
          ...
          <Input v-model="form.password" type="password" label="Nouveau mot de passe" :error="form.errors.password" />
          <Input v-model="form.password_confirmation" type="password" label="Confirmer le mot de passe" class="mt-4" />
        </div>
